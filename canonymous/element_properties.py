...
element_colors = ['lightgrey', '0xD9FFFF', '0xCC80FF', '0xC2FF00', '0xFFB5B5',
                  ...
                  '0xD90045', '0xE00038', '0xE6002E', '0xEB0026', '0xEB0026',
                  '0xEB0026', '0xEB0026', '0xEB0026', '0xEB0026', '0xEB0026',
                  '0xEB0026', '0xEB0026', '0xEB0026']

ELEMENT_PROPS = {s: {"atomic_number": n, "element_color": c}
                 for s, n, c in zip(element_symbols,
                                    range(1, len(element_symbols) + 1),
                                    element_colors)}
